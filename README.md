...
- 🌱 I'm currently learning :
    - **Hexagonal Architecture** | Deepening clean architecture patterns with Java & Spring Boot
    - **Kafka Streams** | Real-time data processing and event-driven microservices
    - **Kubernetes Advanced** | Operators, Helm charts, and production-grade orchestration
    - **GraalVM Native Image** | Compiling Spring Boot apps to native executables for instant startup
    - **Apache Flink** | Stateful stream processing for large-scale data pipelines
    - **Kotlin Coroutines** | Asynchronous programming with Kotlin in a Spring context
    - **dbt (Data Build Tool)** | Transforming data in the warehouse with version-controlled SQL
    - **Apache Iceberg** | Open table format for huge analytic datasets on GCP / Azure
